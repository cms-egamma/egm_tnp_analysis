...
# flag to be Tested
flags = {
    'passEle27orEle115orPho175'  :'(passHLTEle27WPTightGsf==1)||(passHLTEle115CaloIdVTGsfTrkIdT==1)||(passHLTPhoton175==1)',
}
baseOutDir = 'results/LegacyReReco2016/tnpEleTrig'
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 30 && ' + common.cutBaseCommon
