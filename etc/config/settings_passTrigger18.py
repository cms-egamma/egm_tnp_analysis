...
baseOutDir = "results/trigger/UL2018_passheep_finalresult_4etabin_moreptbin"
#############################################################
...
#   { 'var' : 'el_pt' , 'type': 'float', 'bins': [32, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 300, 500., 1000.] },
 ...
 #  { 'var' : 'el_pt' , 'type': 'float', 'bins': [32., 50, 80, 110, 150, 400., 1000.] },
...
#############################################################
# from Jaesung
#for failed bins. These adjustment attempts aim to reduce the parameter ranges and step sizes to improve search precision.
tnpParNomFit = [
...
#These adjustments aim to fine-tune the fitting parameters and improve the agreement between the data and the MC simulation in the specified bin.
#By narrowing the parameter ranges and adjusting the step sizes, the fitting algorithm can explore the parameter space more precisely,
#potentially leading to a smaller error in the scale factor estimation.
