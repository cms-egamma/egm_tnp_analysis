...
baseOutDir = "results/trigger/UL2018_4_18_23_amc_reweight"
#############################################################
...
samplesDef = {
    ...
    "mcNom": tnpSamples.UL2018["DY_amcatnloext_reweight"].clone(),
    "mcAlt": tnpSamples.UL2018["DY_madgraph"].clone(),
    #"mcAlt": tnpSamples.UL2018["mc_DY_amcatnlo_ele"].clone(),
#    "mcAlt": None,
    "tagSel": tnpSamples.UL2018["DY_amcatnloext_reweight"].clone(),
}
...
#    "mcAlt": tnpSamples.UL2017["DY_amcatnloext_reweight"].clone(),
...
#    "mcAlt": tnpSamples.UL2016_preVFP["DY_amcatnloext_reweight"].clone(),
...
#    "mcAlt": tnpSamples.UL2016_postVFP["DY_amcatnloext_reweight"].clone(),
#    "tagSel": tnpSamples.UL2016_postVFP["DY_madgraph"].clone(),
#    #"mcNom": tnpSamples.UL2016_postVFP["DY_amcatnloext_reweight"].clone(),
#    #"mcAlt": tnpSamples.UL2016_postVFP["DY_madgraph"].clone(),
#    #"mcAlt": None,
#    #"tagSel": tnpSamples.UL2016_postVFP["DY_amcatnloext_reweight"].clone(),
#}
## can add data sample easily
...
biningDef = [
 ...
 #  { 'var' : 'el_pt' , 'type': 'float', 'bins': [32,50, 60, 70, 80, 100, 110, 130, 150, 170, 190, 210, 250, 300, 500.] },
   { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5,-1.566,-1.4442, 0.0,  1.4442, 1.566,  2.5] },
  # { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5, 0, 2.5] },
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [32,50,80,110,150,200,350,500] },
